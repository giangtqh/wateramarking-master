...
Sh_diag = diag(Sh); %Sh là matrix chéo(các pt? ???ng chéo #0, còn l?i = 0), l?y các giá tr? ?g chéo t?o thành ma tr?n c?t
Sw_diag = diag(Sw);
% for ii = 1:size(Sw, 1)
%     Sh_diag(ii) = Sw_diag(ii);
% end
%GTR 22.05.14: Thay th? Sh_diag by Sw_diag
...
%GTR 22.05.14: sau ?ó convert v? l?i d?ng ma  tr?n chéo.
