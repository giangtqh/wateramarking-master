...
%GTR 22.05.14: LL band ?ã là 1st step DWT -> LL now is 256x256 sau ?ó
%DWT to 4th level -> LL5
[LL_1, HL_1, LH_1, HH_1] = dwt2(LL, 'haar');    % 1st step DWT  -> length LL1 = 128 = LL2
[LL_2, HL_2, LH_2, HH_2] = dwt2(LL_1, 'haar');  % 2nd step DWT  -> length LL2 = 64
[LL_3, HL_3, LH_3, HH_3] = dwt2(LL_2, 'haar');  % 3rd step DWT  -> length LL3 = 32
[LL_4, HL_4, LH_4, HH_4] = dwt2(LL_3, 'haar');  % 4rth step DWT  -> length LL4 = 16 = LL5, length() return number of collumm
...
LL_4 = reshape(LL_4, 1, length(LL_4)^2);    %GTR chuy?n matrix 16x16 thành 1x256, ví d? [1 2;3 4]=> [1 2 3 4]
